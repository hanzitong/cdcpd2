...
geometry_msgs::msg::Twist kinematics_ros_types::calculateError(
    const geometry_msgs::msg::Pose2D& desired, const geometry_msgs::msg::Pose2D& current)
{
  // this is homogeneous(current).inverse * homogeneous(desired)
  geometry_msgs::msg::Twist diff;
